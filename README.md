...
<p align="center">
  <a href="https://github.com/akwnnwastaken/UsageBar/releases/download/v2.2.0/UsageBar-2.2.0-macOS-arm64.zip"><strong>Download for macOS</strong></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/akwnnwastaken/UsageBar/releases/download/windows-v2.2.0/UsageBar-Setup-x64.exe"><strong>Download for Windows</strong></a>
</p>
...
| --- | --- | --- | --- |
| macOS 13+ · Apple Silicon | `UsageBar-2.2.0-macOS-arm64.zip` | [Download ZIP](https://github.com/akwnnwastaken/UsageBar/releases/download/v2.2.0/UsageBar-2.2.0-macOS-arm64.zip) | [`v2.2.0`](https://github.com/akwnnwastaken/UsageBar/releases/tag/v2.2.0) |
| Windows 10 1809+ · x64 | `UsageBar-Setup-x64.exe` | [Download installer](https://github.com/akwnnwastaken/UsageBar/releases/download/windows-v2.2.0/UsageBar-Setup-x64.exe) | [`windows-v2.2.0`](https://github.com/akwnnwastaken/UsageBar/releases/tag/windows-v2.2.0) |
| Windows 10 1809+ · x64 | `UsageBar-Windows-x64.zip` | [Download portable ZIP](https://github.com/akwnnwastaken/UsageBar/releases/download/windows-v2.2.0/UsageBar-Windows-x64.zip) | [`windows-v2.2.0`](https://github.com/akwnnwastaken/UsageBar/releases/tag/windows-v2.2.0) |
...
- Claude Code'u **WSL** üzerinden okuyabilir; bu yol 2.2.0 sürümünde fiziksel olarak doğrulanmamıştır.
...
1. [`v2.2.0` sürümünden](https://github.com/akwnnwastaken/UsageBar/releases/tag/v2.2.0) `UsageBar-2.2.0-macOS-arm64.zip` dosyasını indirin.
...
1. [`windows-v2.2.0` sürümünü](https://github.com/akwnnwastaken/UsageBar/releases/tag/windows-v2.2.0) açın.
...
1. [`UsageBar-Windows-x64.zip`](https://github.com/akwnnwastaken/UsageBar/releases/download/windows-v2.2.0/UsageBar-Windows-x64.zip) dosyasını indirin.
...
```sh
shasum -a 256 ~/Downloads/UsageBar-2.2.0-macOS-arm64.zip
```

CI tarafından üretilen paketin GitHub build provenance kaydını doğrulamak için:

```sh
gh attestation verify ~/Downloads/UsageBar-2.2.0-macOS-arm64.zip \
...
- Can read Claude Code through **WSL**; that path was not physically validated for the 2.2.0 release.
...
1. Download `UsageBar-2.2.0-macOS-arm64.zip` from the [`v2.2.0` release](https://github.com/akwnnwastaken/UsageBar/releases/tag/v2.2.0).
...
1. Open the [`windows-v2.2.0` release](https://github.com/akwnnwastaken/UsageBar/releases/tag/windows-v2.2.0).
...
1. Download [`UsageBar-Windows-x64.zip`](https://github.com/akwnnwastaken/UsageBar/releases/download/windows-v2.2.0/UsageBar-Windows-x64.zip).
